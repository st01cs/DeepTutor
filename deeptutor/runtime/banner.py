...
LABELS: dict[str, dict[str, str]] = {
    "en": {
        ...
        "start.parent_gone": "Parent process {pid} is gone; shutting down ...",
        "start.auto_ports": "Port {port} is in use; using {new_port} instead.",
    ...
    "zh": {
        ...
        "start.parent_gone": "父进程 {pid} 已退出,正在关闭 ...",
        "start.auto_ports": "端口 {port} 已被占用,改用 {new_port}。",
